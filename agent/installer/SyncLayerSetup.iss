...
[Run]
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\install_finalize.ps1"" -AgentPath ""{app}\SyncLayerAgent.exe"" -AgentDir ""{app}"""; Flags: runhidden waituntilterminated abortiferror runascurrentuser
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\install_verify.ps1"""; Flags: runhidden waituntilterminated abortiferror runascurrentuser
